export default `
// This shader is modifie based on glittery by pxlmage 
// Link: https://www.shadertoy.com/view/clVBDW
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 base = sin(t * 10.0 * vec3(0.345, 0.456, 0.567)) * 0.4 + 0.6;
    vec3 col = m * base;
